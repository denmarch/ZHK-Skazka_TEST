...
$subject = 'Заявка на квартиру - ЖК Первый Николаевский';
...
}else
{
	...
	mail_utf8( 'nahodkaekbb@gmail.com, lobudova@nahodka.pro, 79222220707@ya.ru',
		...
		'<br><br><b>Выбор клиента</b>:<br>Квартиры: '.$ftype.'<br>Стоимость: '.$fprice);
...
$roistatData = array(
    ...
    'title'   => 'Заявка на квартиру - ЖК Первый Николаевский',
